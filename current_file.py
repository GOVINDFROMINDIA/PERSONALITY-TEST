...
def show_question():
    ...
    for i in range(len(q)):
        ...
        if judging[i] == 1:
                j_score += choice
                j_count += 6
    update_score(int_score,int_count,t_score,t_count,intu_score,intu_count,j_score,j_count)

def update_score(int_score,int_count,t_score,t_count,intu_score,intu_count,j_score,j_count):
    ...
    if question_num == len(q):
        ...
        btn77=Button(base,text="graph",command=lambda:graph(1,int_score,int_count), font=("Arial", 25),relief='groove',activebackground="white")
        btn77.place(x=55,y=140)
        btn78=Button(base,text="graph",command=lambda:graph(2,t_score,t_count), font=("Arial", 25),relief='groove',activebackground="white")
        btn78.place(x=85,y=140)
        btn79=Button(base,text="graph",command=lambda:graph(3,intu_score,intu_count), font=("Arial", 25),relief='groove',activebackground="white")
        btn79.place(x=115,y=140)
        btn80=Button(base,text="graph",command=lambda:graph(4,j_score,j_count), font=("Arial", 25),relief='groove',activebackground="white")
